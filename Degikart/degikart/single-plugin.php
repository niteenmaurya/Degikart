...
if (have_posts()) :
    ...
    $tags = get_the_terms($post_id, 'post_tag'); // Get tags for the current post
    ...
    $plugin_preview_url = isset($meta['plugin_preview_url'][0]) ? esc_url($meta['plugin_preview_url'][0]) : '';
...
<div class="sales-bar">
    ...
    <p>
        ...
        <strong> <?php _e('', 'degikart'); ?> </strong> <?php echo esc_html($views); ?>
    </p>
                    ...
                    <div class="inside-article">
                        <div class="post-body" itemprop="text">
                            ...
                            <div class="post-preshot">
                                ...
                                <p><a href="<?php echo $plugin_preview_url; ?>"><?php _e('Plugin Preview', 'degikart'); ?></a></p>
                            </div>
                        </div>
        ...
        <script type="application/ld+json">
{
    ...
    "price": "<?php echo esc_html($regular_price); ?>",  // Regular price included
    "priceCurrency": "USD", // Currency (change if needed)
    "aggregateRating": {
