<?php
/*
Template Name: Blogger Upload Page
*/
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $files_included = sanitize_text_field($_POST['themeforest-files-included']);
...
<form class="form-main" action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
    <div class="form-group">
        <div class="label-container">
            <label for="theme-name"><?php _e('Name:', 'degikart'); ?></label>
        </div>
...
<div class="label-container">
    ...
    <div class="form-group">
        ...
        <div class="input-container">
            <input type="checkbox" id="high-resolution" name="high-resolution" class="input-checkbox">
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="label-container">
            <label for="themeforest-files-included"><?php _e('ThemeForest Files Included:', 'degikart'); ?></label>
        </div>
        <div class="input-container">
            <input type="text" id="themeforest-files-included" name="themeforest-files-included" class="input-text" required>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="input-container">
            <input type="url" id="demo-url" name="demo-url" class="input-url">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <?php
            wp_dropdown_categories(array(
                'taxonomy'         => 'blogger_category', // Custom taxonomy for 'blogger'
                'name'             => 'category',
                'id'               => 'category',
